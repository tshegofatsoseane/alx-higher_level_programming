#!/usr/bin/python3
# test_square.py
"""Define tests for models/square.py.
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """tests forcorder of Square attribute."""
...
class TestSquare_stdout(unittest.TestCase):
    """tests display methods of Square class."""
...
class TestSquare_update_args(unittest.TestCase):
    """tests for args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """tests for kwargs method of Square class."""
