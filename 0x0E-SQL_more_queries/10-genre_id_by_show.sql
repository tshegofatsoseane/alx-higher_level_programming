-- A script to display all shows contained in hbtn_0d_tvshows that have at least one genre linked
-- The script also displays all rows of a database that have one column in common
