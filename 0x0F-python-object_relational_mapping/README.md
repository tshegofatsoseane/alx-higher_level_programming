...
I gained knowledge about object-relational mapping's application to database scripting through this project. I learned how to query, create, modify, and remove tables in MySQL using MySQLdb and SQLAlchemy.
