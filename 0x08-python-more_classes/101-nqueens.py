...
Attributes:
    board (list): A list representing the chessboard lists.
    solutions (list): A list containing solutions sists.
...
def init_board(n):
    """Initialize an nxn hessboard with 0s."""
    board = []
...
def recursive_solve(board, row, queens, solutions):
    ...
    Args:
        ...
        queens (int): The no of placed queens.
